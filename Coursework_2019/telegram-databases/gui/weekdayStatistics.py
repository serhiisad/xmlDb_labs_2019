...
#
#
# class WeekdayStatistics(npyscreen.ActionForm):
#
#     def create(self):
#         self.value = None
#         self.channels = filter.get_channels_names()
#         self.channel = self.add(npyscreen.TitleMultiLine, name="Channel:", values=self.channels, max_height=5)
#         self.filename = self.add(npyscreen.TitleText, name="Filename:", value='weekday.png')
#
#     def beforeEditing(self):
#         self.name = "Weekday statistics"
#
#     def on_ok(self):
...
#             analysis.save_weekdays_statistics(channel, self.filename.value)
