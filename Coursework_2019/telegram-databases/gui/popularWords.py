...
#
#
# class PopularWords(npyscreen.ActionForm):
#
#     def create(self):
#         self.value = None
...
#         self.filename = self.add(npyscreen.TitleText, name="Filename:", value='popularWords.png')
#
#     def beforeEditing(self):
#         self.name = "Popular words"
#
#     def on_ok(self):
...
#             analysis.save_popular_messages_words(channel, self.filename.value)
